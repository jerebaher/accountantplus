...
from src.transactions.views import expense_flow_data, create_transaction, remove_category_from_transaction
...
urlpatterns = [
    ...
    path('api/transactions/remove_category/', remove_category_from_transaction,
         name='remove_category_from_transaction'),
